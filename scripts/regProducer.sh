...
#Example
#./clio.sh push action eosio regproducer '{"fio_address":"cryptolions@fiotestnet","fio_pub_key":"FIO6dibuddHN5fioh3VczFXWJq4M3quFjvXoRKR5S9BwgxLNaYf5L","url":"CryptoLions.io","location":10,"actor":"5tyuyv241iup", "max_fee":"200000000000"}' --permission 5tyuyv241iup@active
