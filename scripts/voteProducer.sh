...
#Example
#./clio.sh push action eosio voteproducer '{"producers":["bp2-west:dapixbp","bp0-east:dapixbp","cryptolions:fiotestnet"],"fio_address":"cryptolions:fiotestnet","actor":"5tyuyv241iup","max_fee":"40000000000"}' -p 5tyuyv241iup@active
