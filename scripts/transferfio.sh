...
#Example
#./clio.sh push action fio.token trnsfiopubky '{"payee_public_key": "FIO6jytk9VbT8DAfq2gyiWhf2qoGsDQ2J8KCAYJPQ7fqpSzYjvTNy","amount": "1000000000000", "max_fee": 250000000, "tpid": "", "actor": "welcome.fio"}' -p welcome.fio@active
